...
class MyGrammerListener(ParseTreeListener):
    ...
    # Enter a parse tree produced by MyGrammerParser#ReadExpr.
    def enterReadExpr(self, ctx:MyGrammerParser.ReadExprContext):
        pass

    # Exit a parse tree produced by MyGrammerParser#ReadExpr.
    def exitReadExpr(self, ctx:MyGrammerParser.ReadExprContext):
        pass
